...
English version: [harness-core-model.md](./harness-core-model.md)
...
这些场景的可移植执行护栏，定义在 [EXECUTION_GUARDRAILS.zh.md](./execution-guardrails.zh.md)。
...
可移植的 context-loading 规则定义在 [CONTEXT_ENGINEERING_PROTOCOL.zh.md](./context-engineering-protocol.zh.md)。
