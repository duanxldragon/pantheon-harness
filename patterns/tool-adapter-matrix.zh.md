...
|| Planning / orchestration | 工作有明确 scope、步骤、风险、验证和执行 lane | agent plan mode（Claude Code / Codex / Cursor）、prompt-driven plan workflow、人工 plan |
|| Plan/design grilling | 在批准或实现前主动挑战方案边界、风险、验收和回滚 | grill-me、人工挑战、pair review |
|| Resumable parallel workflow | 独立分支可并行、恢复，并综合为一个建议 | subagent 扇出、workflow 编排、CI matrix jobs、脚本化批量 review、人工 checklist |
...
|| Browser evidence | 在运行应用中检查用户流程 | Playwright、Chrome DevTools MCP、浏览器 QA 工具、人工浏览器截图 |
