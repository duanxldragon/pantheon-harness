...
| `FR-002` | method-health | method-health-gap | portable-method | 1 | `scripts/harness/README.md` referenced `docs/harness/HARNESS_OPEN_TASKS.md`, but the file was missing. | A documented promotion plan pointed to a broken link, weakening the method's own evidence trail. | method-gate | `scripts/harness/README.md` | `scripts/harness/check-doc-links.mjs` | documentation review | repository scan | previous adoption check | template | template-updated | none | implemented |
