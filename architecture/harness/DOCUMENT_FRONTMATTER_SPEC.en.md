...
Chinese version: [DOCUMENT_FRONTMATTER_SPEC.md](./DOCUMENT_FRONTMATTER_SPEC.md)
...
The contract body may retain readable related sections, but they should match the frontmatter.
